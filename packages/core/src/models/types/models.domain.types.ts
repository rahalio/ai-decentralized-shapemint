...
export type UpdateModelRequestInput = NonNullable<operations["updateModel"]["requestBody"]>["content"]["application/json"];
export type UpdateModelRequest = UpdateModelRequestInput;
...
export type UpdateModelParams = operations["updateModel"]["parameters"]["path"];
...
export type UpdateModelResponse = operations["updateModel"]["responses"]["200"]["content"]["application/json"];
