 ...
 *
 * @returns The core table name (e.g., "shapemint-core-dev")
 ...
 *
 * @returns The base table name (e.g., "shapemint-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "shapemint-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "shapemint-app-realtime-dev")
