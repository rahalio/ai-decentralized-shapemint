/**
 * Protocols Services - Application Layer Export
 *
...
/**
 * Protocols Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for protocols domain.
 */
