 ...
 * Influence Domain
 *
 * Barrel export for influence service, types, hooks, and view models.
 *
 * Architecture Rules:
 * - API types: re-exports from @shapemint/core only
...
// ============================================================================
export { influenceService } from './influence.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { influenceFacade } from './facade';
